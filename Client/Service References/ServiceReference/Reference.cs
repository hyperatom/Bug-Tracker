...
namespace Client.ServiceReference {
    ...
    public interface ITrackerService {
        ...
        void AcceptUserOnProject(Client.ServiceReference.User user, Client.ServiceReference.Project project, string rolename);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITrackerService/GetUsersRequestedRoleForProject", ReplyAction="http://tempuri.org/ITrackerService/GetUsersRequestedRoleForProjectResponse")]
        string GetUsersRequestedRoleForProject(Client.ServiceReference.User user, Client.ServiceReference.Project project);
    }
    ...
    public partial class TrackerServiceClient : System.ServiceModel.ClientBase<Client.ServiceReference.ITrackerService>, Client.ServiceReference.ITrackerService {
        ...
        public void AcceptUserOnProject(Client.ServiceReference.User user, Client.ServiceReference.Project project, string rolename) {
            base.Channel.AcceptUserOnProject(user, project, rolename);
        }
        ...
        public string GetUsersRequestedRoleForProject(Client.ServiceReference.User user, Client.ServiceReference.Project project) {
            return base.Channel.GetUsersRequestedRoleForProject(user, project);
        }
    }
}
